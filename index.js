...
module.exports = function(hosts, containers, opts) {
    opts = opts || {}
    var unified_containers = utils.unifyContainers(containers, opts.ignore, opts.omit)
...
module.exports.diff = function(hosts, current_containers, wanted_containers, opts) {
    opts = opts || {}
    var unified_current_containers = utils.unifyContainers(current_containers, opts.ignore, opts.omit)
    var unified_wanted_containers  = utils.unifyContainers(wanted_containers, opts.ignore, opts.omit)
